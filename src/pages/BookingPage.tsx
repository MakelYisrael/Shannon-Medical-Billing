            ...
            {services.map((service, index) => {
              ...
              return (
                <Card key={index} className="flex flex-col">
                  ...
                  <CardFooter>
                    <Button
                      className="w-full bg-blue-600 text-white hover:bg-blue-700 active:bg-blue-800 transition-colors"
                      onClick={() => {
      ...
      <section className="bg-blue-600 text-white py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Button
            size="lg"
            variant="secondary"
            className="bg-white text-blue-600 hover:bg-gray-100 active:bg-gray-200 transition-colors"
