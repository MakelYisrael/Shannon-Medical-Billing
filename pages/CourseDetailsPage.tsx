      ...
      <section className={`bg-gradient-to-br ${course.gradient} py-12 md:py-20`}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
            <Button size="lg" className={`w-full sm:w-auto ${course.buttonColor}`}>
      ...
      <section className={`${course.buttonColor} text-white py-20`}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button size="lg" variant="outline" className="border-white border-2 text-white bg-white/20 hover:bg-white/30" asChild>
